...
- Distribution: npm wrapper, curl installer, GoReleaser multi-platform builds
...
- Auto npm publish on release via GitHub Actions

### Fixed

- MCP capabilities now correctly advertise tools support (`{"tools":{}}`)
- Skills and agents install to `.claude/` instead of `.projects/`

[1.0.0]: https://github.com/orchestra-mcp/mcp/releases/tag/v1.0.0
